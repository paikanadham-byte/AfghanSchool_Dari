...
const URGENT = {
  fa: '⚠️ این گفتگو جایگزین داکتر نیست. اگر نشانه‌های خطر (درد سینه، تنگی نفس، بی‌هوشی، خون‌ریزی شدید، تشنج، یا تب شدید در طفل) دارید، همین امروز به نزدیک‌ترین کلینیک یا شفاخانه مراجعه کنید و این پیام را به داکتر نشان بدهید.',
  ps: '⚠️ دا خبرې اترې د ډاکټر ځای نه نیسي. که د خطر نښې (د سینې درد، د ساه تنګي، بې هوښي، ډېره وینه، اختلاج، یا د ماشوم لوړه تبه) لرئ، نن نږدې کلینیک یا روغتون ته ولاړ شئ او دا پیغام ډاکټر ته وښایاست.',
  en: '⚠️ This chat does not replace a doctor. If you have danger signs (chest pain, difficulty breathing, fainting, heavy bleeding, a seizure, or high fever in a baby), go to the nearest clinic or hospital today and show this message to the doctor.'
};
